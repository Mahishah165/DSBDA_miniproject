...
if user_menu == 'Medal tally':
    ...
    selected_ct = st.sidebar.selectbox("Select country",country)

    medal_tally = helper.fetch_medal_tally(df,selected_yr,selected_ct)

    if selected_yr == 'Overall' and selected_ct == 'Overall':
        st.title("Overall Medal Tally")
    if selected_yr != 'Overall' and selected_ct == 'Overall':
        st.title("Medal Tally in " + str(selected_yr))
    if selected_yr == 'Overall' and selected_ct != 'Overall':
        st.title("Overall Medal Tally for " + selected_ct)
    if selected_yr != 'Overall' and selected_ct != 'Overall':
        st.title("Medal Tally for " + selected_ct + "for the year " + str(selected_yr))
...
if user_menu == 'Country-Wise Analysis':
    ...
    pt = helper.country_event_map(df,selected_country)
    ...
    top10 = helper.most_successful_athlete(df,selected_country)
    st.table(top10)

if user_menu == 'Athlete-wise Analysis':
    st.title("Age Wise Distribution of Medalist")
